...
export interface AppState
{
    ...
    //income: ExpenseInterface // expense.reducer <- LazyLoad
}
...
export const ReducerInterface: ActionReducerMap<AppState> = {
    ...
    //income: ExpenseReducer <- LazyLoad
};

export interface ExpenseAppState extends AppState
{
    income: ExpenseInterface
}